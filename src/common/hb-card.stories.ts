...
const CardTemplate = ({text: name, mediaUrl, description, mediaHref}: HorizontalCardProps) => html`
    <hb-card        
        text=${name}
...
// @ts-ignore 
const Template: Story<Partial<HorizontalCardProps>> = (args:HorizontalCardProps) => CardTemplate(args);
