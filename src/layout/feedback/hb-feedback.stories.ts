...
const FeedbackTemplate = ({}: FeedbackProps) => html`
...
window.addEventListener("test-feedback-alert", (event:any) => {
    alert("Test Feedback Alert\n\nDetail:\n" + JSON.stringify(event.detail));
});


// @ts-ignore 
const Template: Story<Partial<FeedbackProps>> = (args:FeedbackProps) => FeedbackTemplate(args);
