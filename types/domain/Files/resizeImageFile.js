 ...
 */
export const resizeImageFile = async (file, maxSize, nameQualifier) => {
...
const getFileNameWithQualifier = (name, qualifier) => {
    if (!qualifier) {
        return name;
    }
...
const waitOnImageLoad = (image, src) => {
...
const getResizedImageDimensions = (max, image) => {
